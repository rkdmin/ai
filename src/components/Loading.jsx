...
export default function Loading({
  ...
  return (
    <div style={{ width: '100%', minHeight: '100dvh', background: '#fff', color: '#000', display: 'flex', flexDirection: 'column' }}>
      <StatusBar />
      <div style={{ display: 'flex', justifyContent: 'flex-end', padding: '6px 22px 14px', flexShrink: 0 }}>
      ...
      <div style={{ flex: 1 }} />
      <div style={{ padding: '0 24px max(env(safe-area-inset-bottom), 30px)', textAlign: 'center', flexShrink: 0 }}>
        <button
          onClick={onCancel}
          style={{
