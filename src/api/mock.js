  ...
  return [
    ...
    },
    {
      ...
      makeup: {
        ...
        eyebrow: '부드러운 세미 아치', eyebrowReason: '둥근 아치형이 얼굴의 러블리한 인상과 어우러져 자연스러운 입체감을 줍니다.',
        eyeliner: '눈꼬리 내리기 (강아지상)', eyelinerReason: '눈꼬리를 살짝 내려 그려 순하고 사랑스러운 이미지를 강조합니다.',
        highlighter: '콧대 하이라이터 (짧게)', highlighterReason: '콧대 중앙에 짧게 하이라이터를 넣으면 입체감을 주면서도 코가 낮아 보이는 단점을 보완합니다.',
      },
    ...
    },
    {
      ...
      makeup: {
        ...
        eyebrow: '내추럴 일자형', eyebrowReason: '자연스럽고 정돈된 형태가 오피스 룩의 단정한 인상을 완성합니다.',
        eyeliner: '브라운 얇은 라인', eyelinerReason: '얇고 부드러운 라인이 눈매를 정돈하면서 과하지 않은 세련미를 줍니다.',
        highlighter: '매트 하이라이터 (이마/앞볼)', highlighterReason: '펄 없이 밝은 파우더만 얹으면 깔끔하고 고급스러운 오피스 피부 표현이 완성됩니다.',
      },
      featureTip: null,
    ...
    },
    {
      ...
      makeup: {
        ...
        eyebrow: '진한 블랙 눈썹', eyebrowReason: '두껍고 진한 눈썹이 전체 메이크업을 무겁게 눌러 얼굴이 피곤해 보입니다.',
        eyeliner: '블랙 두꺼운 라인', eyelinerReason: '굵은 아이라인이 눈매를 답답하게 하고 봄 웜톤의 맑은 이미지를 해칩니다.',
        highlighter: '글리터 / 과한 펄', highlighterReason: '지나친 펄감이 피부를 들뜨게 보이게 하고 봄 웜톤의 투명한 피부 표현을 방해합니다.',
      },
      featureTip: null,
  ...
  return [
    ...
    },
    {
      ...
      makeup: {
        ...
        eyebrow: '부드러운 세미 아치', eyebrowReason: '자연스러운 아치가 얼굴의 입체감을 살리고 글램 무드와 잘 어우러집니다.',
        eyeliner: '눈꼬리 내리기 (강아지상)', eyelinerReason: '눈꼬리를 살짝 내리면 세련된 글램 속에서도 부드러운 인상이 유지됩니다.',
        highlighter: '콧대 하이라이터 (짧게)', highlighterReason: '레이어드 컷의 입체적인 무드와 함께 콧대 하이라이터가 시선을 자연스럽게 중앙으로 집중시킵니다.',
      },
    ...
    },
    {
      ...
      makeup: {
        ...
        eyebrow: '내추럴 일자형', eyebrowReason: '단정하고 자연스러운 눈썹이 오피스 룩의 정돈된 인상과 잘 맞습니다.',
        eyeliner: '브라운 얇은 라인', eyelinerReason: '차분한 컬러의 얇은 라인이 눈매를 정리하면서도 과하지 않아 좋습니다.',
        highlighter: '매트 하이라이터 (이마/앞볼)', highlighterReason: '단발 외컬의 깔끔한 실루엣과 어울려 피부를 자연스럽게 밝혀줍니다.',
      },
      featureTip: null,
    ...
    },
    {
      ...
      makeup: {
        ...
        eyebrow: '진한 블랙 눈썹', eyebrowReason: '두꺼운 눈썹이 전체 메이크업과 함께 얼굴을 무겁고 어둡게 만듭니다.',
        eyeliner: '블랙 두꺼운 라인', eyelinerReason: '굵은 아이라인이 눈매를 답답하게 눌러 봄 웜톤의 맑은 이미지를 해칩니다.',
        highlighter: '글리터 / 과한 펄', highlighterReason: '과한 펄이 피부를 들뜨게 보이게 하고 무거운 전체 스타일과 어울리지 않아 산만해 보입니다.',
      },
      featureTip: null,
